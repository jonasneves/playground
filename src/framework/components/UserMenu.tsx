  ...
  return (
    <div ref={menuRef} className="fixed top-3 right-3 z-50">
      ...
      >
        ...
        />
        <span className="text-sm font-medium text-neutral-600 whitespace-nowrap w-0 group-hover:w-auto opacity-0 group-hover:opacity-100 transition-all duration-200">{user.name?.split(' ')[0] || user.login}</span>
      </button>
